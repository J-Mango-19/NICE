...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(mnist_data, batch_size=args.batch_size, shuffle=True)
    ...
    if not args.fresh:
        model_load_success = load_model(nice_model, 'nice_model_weights.pth', device)
    ...
    if args.train == True:
        optimizer = torch.optim.Adam(nice_model.parameters(), lr=args.lr, betas=(args.beta_1, args.beta_2), eps=args.eps, weight_decay=args.wd)
